...
const   /*启用查看大图查看原图按钮*/conf_imgView_open=false;
const /*启用建站时长计时 [是否启用t/f,年,月,日]*/conf_time=[true,2024,12,25];
const /*左侧边栏·一言*/conf_saying=`不是最好的体验却是尽心尽力的服务`;
const /*左侧边栏·第1格·背景图片*/conf_sidebar_headimg_src=`http://kdxiaoyi.top/Streack/assets/img/cover.png`;
const   /*左侧边栏·第1格·背景图片描述*/conf_sidebar_headimg_alt=`栈流`;
...
<s-icon slot="start"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M600-160q-134 0-227-93t-93-227q0-133 93-226.5T600-800q133 0 226.5 93.5T920-480q0 134-93.5 227T600-160Zm0-80q100 0 170-70t70-170q0-100-70-170t-170-70q-100 0-170 70t-70 170q0 100 70 170t170 70Zm91-91 57-57-108-108v-144h-80v177l131 132ZM80-600v-80h160v80H80ZM40-440v-80h200v80H40Zm40 160v-80h160v80H80Zm520-200Z"></path></svg></s-icon>
文档</s-chip>`;
...
const /*在页面底端增加文章脚注，为空不额外添加*/conf_footer=`<small>Copyright © 2025, 栈流Streack.<br>本站点和服务器与Mojang Studio、Microsoft、网易Netease均没有关联。</small>`;
