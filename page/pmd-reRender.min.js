...
首页</s-chip>
<s-chip id="side_ship_1" onclick="openURL('/Streack/join','')" clickable="true" class="sidebar_btn">
...
const /*在页面底端增加文章脚注，为空不额外添加*/conf_footer=`Copyright © 2025, 栈流Streack.<br><small>本站点和服务器与Mojang Studio、Microsoft、网易Netease均没有关联。</small>`;
