...
<s-chip id="side_ship_0" onclick="openURL('/kdxSMP/','')" clickable="true" class="sidebar_btn">
<s-icon slot="start" type="home"></s-icon>
首页</s-chip>
<s-chip id="side_ship_1" onclick="openURL('/kdxSMP/join','')" clickable="true" class="sidebar_btn">
...
加入服务器</s-chip>
<s-chip id="side_ship_2" onclick="openURL('/kdxSMP/doc/','')" clickable="true" class="sidebar_btn">
